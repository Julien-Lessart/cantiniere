...
import { Options } from '../../models/modal.model';
...
export class ModalComponent implements AfterViewInit {
  ...
  addOptions() {
    ...
    this.modal.nativeElement.style.borderColor = 
      this.options?.border?.color || '#1d6154';
    this.modal.nativeElement.style.borderWidth = 
      this.options?.border?.width || '0.2em';
    this.modal.nativeElement.style.borderStyle = 
      this.options?.border?.style || 'solid';
      this.modal.nativeElement.style.borderRadius = 
      this.options?.border?.radius || '2em';
    this.modal.nativeElement.style.backgroundColor = 
      this.options?.backgroundColor || '#fffef8';
